...
1. Append the file `test.scm` at the end of your code of `full.scm`
   1. Optionally, if you are comfortable using command line: `cat threepoints.scm test.scm > full.scm`. This will concatenate your file with the test file and create a new file called `full.pl`.
...
1. Run your parser: `ruby parser.rb test.cpl -s > mytest.scm`
1. Paste your generated test to your prolog program: `cat threepoints.scm mytest.scm > full.scm`
